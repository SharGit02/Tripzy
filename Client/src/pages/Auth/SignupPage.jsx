...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.name || !form.email || !form.password || !form.repeat) {
    ...
    >
      ...
      <div className="w-full max-w-5xl rounded-3xl overflow-hidden shadow-2xl flex flex-col lg:flex-row bg-white">
        {/* ══════════════════════════════════════════
            ...
            ══════════════════════════════════════════ */}
        <div
          className="hidden lg:flex flex-[0_0_46%] relative overflow-hidden min-h-[580px]"
          style={{
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#eef7fc]/60 via-transparent to-transparent" />
        ...
        <div className="flex-1 bg-white relative flex items-center justify-center px-6 sm:px-10 py-8 overflow-hidden">
          ...
          <div className="w-full max-w-md flex items-stretch gap-5">
            ...
            <div className="hidden lg:flex flex-col items-center gap-3 py-2 pl-2">
              ...
              <motion.button
                ...
                className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm transition-colors cursor-pointer"
                style={{ border: "1.5px solid #e2e8f0" }}
          ...
          {/* Mobile social buttons row */}
          <div className="flex lg:hidden items-center justify-center gap-4 mt-6 pt-4 border-t border-slate-100">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Or continue with:</span>
            <button
              type="button"
              onClick={handleGithubLogin}
              className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm border border-slate-200 hover:border-[#14b8a6] transition-colors"
              title="Sign up with GitHub"
            >
              <svg width="17" height="17" viewBox="0 0 24 24" fill="#181717">
                <path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z" />
